        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <input type="text" name="kategori_code" id="kategori_code" class="form-control" required> 
                    <small id="error-kategori_code" class="error-text form-text text-danger"></small> 
                </div> 
                <div class="form-group"> 
